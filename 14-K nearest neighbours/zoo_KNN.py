"""
Problem:-
A National Zoopark in India is dealing with the problem of segregation of the 
animals based on the different attributes they have. Build a KNN model to 
automatically classify the animals. Explain any inferences you draw in the documentation
"""
"""
Maximize: The accuracy of model so that it is easy to classify the animals in the zoo
Minimize: To reduce the no. of errors or to reduce the incorrectly predicted values
Business constraints: To help in the segragation of animals
"""
import pandas as pd
import numpy as np
zoo = pd.read_csv("C:/2-Dataset/zoo.csv")
zoo
