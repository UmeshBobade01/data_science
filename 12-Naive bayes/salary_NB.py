"""
Problem Statement saved at c/DS Assignment/naive bayes Prepare a classification model using the Naive Bayes algorithm 
...
df=pd.read_csv('C:/2-dataset/SalaryData_Train.csv')
df.head()
df.shape
...
Test_data=pd.read_csv('C:/2-dataset/SalaryData_Test.csv')
Test_data.head()
...
y=Test_data[['Salary']]
###########################################
Train_data=pd.read_csv('C:/2-dataset/SalaryData_Train.csv')
Train_data
############################################
