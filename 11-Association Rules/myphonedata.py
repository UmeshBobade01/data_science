...
Maximize: The the sells by identifying pattern of frequently  buyed products
...
df=pd.read_csv('Association Rules/myphonedata.csv')
df
...
df_norm=norm_fun(a)
df_norm
# The mean and median diffrence is in the range of 0-1 and 
# the standard deviation is also near to zero
...
data=pd.read_csv('Association Rules/myphonedata.csv')
data
...
###################################################
# By using this data we can find out which mobile people will 
#prefer and which mobiles have more possibiliteis to buy together 
