...
Maximize: increase the likes for movies and customer satisfaction

Minimize: reduce the dislikes 
...
df=pd.read_csv('Association Rules/my_movies.csv')
df

####################################
df.columns
# the dataset contains the reviews of customers for 10 movies 
'''
...
item_frequencies=Counter(df_norm)
...
nx.draw_networkx(G, pos, with_labels=True, node_size=2500, node_color="skyblue", font_size=10, font_color="black", font_weight="bold", edge_color="gray", linewidths=1, alpha=0.7)
